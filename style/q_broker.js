			...
			if (data.code === 200) {
				...
				for (let j = 0; j < d.length; j++) {
					...
					for (let i = 0; i < d[j].rate_cost; i++) {
						htmlText += '<img src="images/icons/ico_xing_wanz_b.png">';
					}
					for (let i = 0; i < 5 - d[j].rate_cost; i++) {
						htmlText += '<img src="images/icons/ico_xing_yiban_b.png">';
					}
					...
					htmlText += '</div>\
							...
							j].ding_sum + '</span><img src="images/icons/ico_dianzai.png" data-ding-type="1" onclick="ding(this,' + d[j].id +
						')"></span>\
